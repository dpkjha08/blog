! function(e, t) {
    ...
    return function() {
        ...
        for (var Me = "\xd0\xde\xfe", ze = 0; ze < Me.length; ze++) {
            var Ae = Me.charAt(ze);
                ...
                makeOrd: function(e, t, r) {
                    ...
                    if ("textord" === r) {
                        ...
                        if ("ams" === v) {
                            ...
                            return Pe(i, b, a, t, o.concat("amsrm", t.fontWeight, t.fontShape))
                        }
                        if ("main" !== v && v) {
        ...
        var kt = function() {
            ...
            Tt = function(e, t) {
                ...
                var a = e.text;
                return l.contains(["\\imath", "\\jmath"], a) ? null : (X[n][a] && X[n][a].replace && (a = X[n][a].replace), V(a, je.fontMap[r].fontName, n) ? je.fontMap[r].variant : null)
            },
            Bt = function(e, t, r) {
                if (1 === e.length) {
                    var n = qt(e[0], t);
        ...
        var It = function(e) {
            ...
            Dt = function(e) {
                var t = new Mt.MathNode("mo", [new Mt.TextNode(Et[e.replace(/^\\/, "")])]);
        ...
        var Ut = function(e, t) {
                var r, n, a;
                e && "supsub" === e.type ? (r = (n = Ft(e.base, "accent")).base, e.base = r, a = function(e) {
                    if (e instanceof N) return e;
                    throw new Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
                }(bt(e, t)), e.base = n) : r = (n = Ft(e, "accent")).base;
                ...
                if (n.isStretchy) h = Pt(n, t), h = je.makeVList({
                    ...
                    var u, p;
                    "\\vec" === n.label ? (u = je.staticSvg("vec", t), p = je.svgData.vec[1]) : ((u = L(u = je.makeOrd({
                        mode: n.mode,
                        text: n.label
                    }, t, "textord"))).italic = 0, p = u.width, m && (c += u.depth)), h = je.makeSpan(["accent-body"], [u]);
                    var d = "\\textcircled" === n.label;
                    d && (h.classes.push("accent-full"), c = i.height);
                    var f = o;
                    d || (f -= p / 2), h.style.left = f + "em", "\\textcircled" === n.label && (h.style.top = ".2em"), h = je.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                            elem: i
                ...
                var g = je.makeSpan(["mord", "accent"], [h], t);
            ...
            Wt = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((function(e) {
                return "\\" + e
            })).join("|"));
        nt({
            type: "accent",
        ...
        nt({
            ...
            handler: function(e, t) {
                for (var r = e.parser, a = Ft(t[0], "ordgroup").body, i = "", o = 0; o < a.length; o++) {
        ...
        nt({
            ...
            handler: function(e) {
                var t = e.parser,
                    ...
                    a = t.gullet.popToken(),
                    i = t.gullet.popToken();
                return er(t, n, i, "\\\\globalfuture" === r), t.gullet.pushToken(i), t.gullet.pushToken(a), {
                    type: "internal",
                    mode: t.mode
                }
            }
        ...
        var tr = function(e, t, r) {
            ...
            ir = function(e, t, r) {
                ...
                return n = "Size1-Regular" === t ? "delim-size1" : "delim-size4", {
                    type: "elem",
                    elem: je.makeSpan(["delimsizinginner", n], [je.makeSpan([], [je.makeSymbol(e, t, r)])])
                }
            },
            or = function(e, t, r) {
            ...
            mr = function(e, t, r, n, a, i) {
                ...
                var N = n.havingBaseStyle(b.TEXT),
                    q = je.makeVList({
                        positionType: "bottom",
                        positionData: z,
                        children: A
                    }, N);
                return rr(je.makeSpan(["delimsizing", "mult"], [q], N), b.TEXT, n, i)
            },
            cr = .08,
            ...
            Sr = function(e, t) {
                var r, n, a = t.havingBaseSizing(),
                    ...
                    h = 0,
                    m = 0;
                return "small" === i.type ? (e < 1 ? o = 1 : e < 1.4 && (o = .7), h = (1 + s) / o, (r = ur("sqrtMain", l = (1 + s + cr) / o, m = 1e3 + 1e3 * s + 80, s, t)).style.minWidth = "0.853em", n = .833 / o) : "large" === i.type ? (m = 1080 * gr[i.size], h = (gr[i.size] + s) / o, l = (gr[i.size] + s + cr) / o, (r = ur("sqrtSize" + i.size, l, m, s, t)).style.minWidth = "1.02em", n = 1 / o) : (l = e + s + cr, h = e + s, m = Math.floor(1e3 * e + s) + 80, (r = ur("sqrtTall", l, m, s, t)).style.minWidth = "0.742em", n = 1.056), r.height = h, r.style.height = l + "em", {
                    span: r,
                    advanceWidth: n,
            ...
            Mr = function(e, t, r, a, i) {
                if ("<" === e || "\\lt" === e || "\u27e8" === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && "\u27e9" !== e || (e = "\\rangle"), l.contains(pr, e) || l.contains(fr, e)) return ar(e, t, !1, r, a, i);
            ...
            Nr = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230a", "\u230b", "\\lceil", "\\rceil", "\u2308", "\u2309", "<", ">", "\\langle", "\u27e8", "\\rangle", "\u27e9", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27ee", "\u27ef", "\\lmoustache", "\\rmoustache", "\u23b0", "\u23b1", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];

        function qr(e, t) {
            var r = Gt(e);
            if (r && l.contains(Nr, r.text)) return r;
        ...
        nt({
            ...
            htmlBuilder: function(e, t) {
                return "." === e.delim ? je.makeSpan([e.mclass]) : Mr(e.delim, e.size, t, e.mode, [e.mclass])
            },
            mathmlBuilder: function(e) {
                var t = [];
                "." !== e.delim && t.push(zt(e.delim, e.mode));
                var r = new Mt.MathNode("mo", t);
                return "mopen" === e.mclass || "mclose" === e.mclass ? r.setAttribute("fence", "true") : r.setAttribute("fence", "false"), r.setAttribute("stretchy", "true"), r.setAttribute("minsize", zr[e.size] + "em"), r.setAttribute("maxsize", zr[e.size] + "em"), r
            }
        }), nt({
        ...
        var Ir = function(e, t) {
                ...
                if (e.backgroundColor) a = je.makeVList({
                    positionType: "individualShift",
                    children: [{
                        type: "elem",
                        elem: r,
        ...
        function Dr(e, t, r) {
            ...
            for (b.push(Hr(e));;) {
                ...
                e.gullet.endGroup(), e.gullet.beginGroup(), y = {
                    type: "ordgroup",
                    mode: e.mode,
                    body: y
                }, r && (y = {
                ...
                if ("&" === x) {
                    ...
                    if ("\\end" === x) {
                        1 === f.length && "styling" === y.type && 0 === y.body[0].body.length && (g.length > 1 || !c) && g.pop(), b.length < g.length + 1 && b.push([]);
                        break
                    }
                    if ("\\\\" !== x) throw new n("Expected & or \\\\ or \\cr or \\end", e.nextToken);
                    e.consume();
                    var w = void 0;
                    " " !== e.gullet.future().text && (w = e.parseSizeGroup(!0)), v.push(w ? w.value : null), b.push(Hr(e)), f = [], g.push(f)
                }
            }
        ...
        var Fr = function(e, t) {
                ...
                for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
                    for (var D = I[q] || {}, P = !0;
                        "separator" === D.type;) {
                        if (P || ((N = je.makeSpan(["arraycolsep"], [])).style.width = t.fontMetrics().doubleRuleSep + "em", R.push(N)), "|" !== D.separator && ":" !== D.separator) throw new n("Invalid separator type: " + D.separator);
                    ...
                    if (!(a >= s)) {
                        var G = void 0;
                        (a > 0 || e.hskipBeforeAndAfter) && 0 !== (G = l.deflt(D.pregap, p)) && ((N = je.makeSpan(["arraycolsep"], [])).style.width = G + "em", R.push(N));
                        var U = [];
                        for (r = 0; r < i; ++r) {
                            var Y = h[r],
                                W = Y[a];
                        ...
                        U = je.makeVList({
                            positionType: "individualShift",
                            children: U
                        }, t), U = je.makeSpan(["col-align-" + (D.align || "c")], [U]), R.push(U), (a < s - 1 || e.hskipBeforeAndAfter) && 0 !== (G = l.deflt(D.postgap, p)) && ((N = je.makeSpan(["arraycolsep"], [])).style.width = G + "em", R.push(N))
                    }
                }
                if (h = je.makeSpan(["mtable"], R), m.length > 0) {
                    for (var _ = je.makeLineSpan("hline", t, c), j = je.makeLineSpan("hdashline", t, c), $ = [{
                            type: "elem",
                            elem: h,
                            shift: 0
                        }]; m.length > 0;) {
        ...
        Er({
            ...
            handler: function(e, t) {
                var r = (Gt(t[0]) ? [t[0]] : Ft(t[0], "ordgroup").body).map((function(e) {
                        var t = Vt(e).text;
            ...
            handler: function(e, t) {
                ...
                if ((a = Dr(e.parser, a, "script")).body.length > 0 && a.body[0].length > 1) throw new n("{subarray} can contain only one column");
                return a
            },
            htmlBuilder: Fr,
            mathmlBuilder: Gr
        ...
        var Jr = function(e, t) {
            ...
            Qr = function(e, t) {
                ...
                if (e.hasBarLine ? (e.barSize ? (m = Le(e.barSize, t), h = je.makeLineSpan("frac-line", t, m)) : h = je.makeLineSpan("frac-line", t), m = h.height, c = h.height) : (h = null, m = 0, c = t.fontMetrics().defaultRuleThickness), n.size === b.DISPLAY.size || "display" === e.size ? (u = t.fontMetrics().num1, p = m > 0 ? 3 * c : 7 * c, d = t.fontMetrics().denom1) : (m > 0 ? (u = t.fontMetrics().num2, p = c) : (u = t.fontMetrics().num3, p = 3 * c), d = t.fontMetrics().denom2), h) {
                    ...
                    S < p && (u += .5 * (p - S), d += .5 * (p - S)), f = je.makeVList({
                        positionType: "individualShift",
                        children: [{
                            type: "elem",
                            elem: x,
                ...
                return r = t.havingStyle(n), f.height *= r.sizeMultiplier / t.sizeMultiplier, f.depth *= r.sizeMultiplier / t.sizeMultiplier, g = n.size === b.DISPLAY.size ? t.fontMetrics().delim1 : n.size === b.SCRIPTSCRIPT.size ? t.havingStyle(b.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, v = null == e.leftDelim ? vt(t, ["mopen"]) : Ar(e.leftDelim, g, !0, t.havingStyle(n), e.mode, ["mopen"]), y = e.continued ? je.makeSpan([]) : null == e.rightDelim ? vt(t, ["mclose"]) : Ar(e.rightDelim, g, !0, t.havingStyle(n), e.mode, ["mclose"]), je.makeSpan(["mord"].concat(r.sizingClasses(t)), [v, je.makeSpan(["mfrac"], [f]), y], t)
            },
            en = function(e, t) {
        ...
        var nn = function(e, t) {
            ...
            if (n.isOver ? (i = je.makeVList({
                ...
                }, t)).children[0].children[0].children[1].classes.push("svg-align") : (i = je.makeVList({
                    positionType: "bottom",
        ...
        var sn = function(e, t, r, n, a, i, o) {
                ...
                if (t) {
                    var u = bt(t, n.havingStyle(a.sup()), n);
                    h = {
                        elem: u,
                ...
                if (r) {
                    var p = bt(r, n.havingStyle(a.sub()), n);
                    s = {
                        elem: p,
                ...
                var v = [m];
                if (s && 0 !== i && !c) {
                    var b = je.makeSpan(["mspace"], [], n);
                    b.style.marginRight = i + "em", v.unshift(b)
                }
                return je.makeSpan(["mop", "op-limits"], v, n)
            },
            ln = ["\\smallint"],
            hn = function(e, t) {
                var r, n, a, i = !1;
                ...
                if (s.size === b.DISPLAY.size && a.symbol && !l.contains(ln, a.name) && (h = !0), a.symbol) {
                    ...
                    var d = ut(a.body, t, !0);
                    1 === d.length && d[0] instanceof R ? (o = d[0]).classes[0] = "mop" : o = je.makeSpan(["mop"], d, t)
                } else {
                ...
                var v = 0,
                    y = 0;
                return (o instanceof R || "\\oiint" === a.name || "\\oiiint" === a.name) && !a.suppressBaseShift && (v = (o.height - o.depth) / 2 - t.fontMetrics().axisHeight, y = o.italic), i ? sn(o, r, n, t, s, y, v) : (v && (o.style.position = "relative", o.style.top = v + "em"), o)
            },
            mn = function(e, t) {
                var r;
        ...
        nt({
            ...
            type: "ordgroup",
            htmlBuilder: function(e, t) {
                return e.semisimple ? je.makeFragment(ut(e.body, t, !1)) : je.makeSpan(["mord"], ut(e.body, t, !0), t)
            },
            mathmlBuilder: function(e, t) {
            ...
            htmlBuilder: function(e, t) {
                ...
                return r = je.makeVList({
                    positionType: "firstBaseline",
                    children: [{
                        type: "elem",
                        elem: r
                    }]
                }, t), je.makeSpan(["mord"], [r], t)
            },
            mathmlBuilder: function(e, t) {
        ...
        var vn = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"];
        nt({
            type: "sizing",
            names: vn,
            props: {
        ...
        var yn = function(e, t) {
            var r = e.base;
            return r ? "op" === r.type ? r.limits && (t.style.size === b.DISPLAY.size || r.alwaysHandleSupSub) ? hn : null : "operatorname" === r.type ? r.alwaysHandleSupSub && (t.style.size === b.DISPLAY.size || r.limits) ? fn : null : "accent" === r.type ? l.isCharacterBox(r.base) ? Ut : null : "horizBrace" === r.type && !e.sub === r.isOver ? nn : null : null
        };
        at({
            type: "supsub",
            htmlBuilder: function(e, t) {
                ...
                if (n && a) {
                    ...
                    u = Math.max(u, i, n.depth + .25 * c.xHeight), v = je.makeVList({
                        positionType: "shift",
                        positionData: -u,
                        children: [{
                            type: "elem",
        ...
        at({
            ...
            mathmlBuilder: function(e, t) {
                var r = new Mt.MathNode("mi", [zt(e.text, e.mode, t)]),
                    n = Tt(e, t) || "italic";
                return n !== xn[r.type] && r.setAttribute("mathvariant", n), r
            }
        }), at({
            type: "textord",
            htmlBuilder: function(e, t) {
            ...
            mathmlBuilder: function(e, t) {
                var r, n = zt(e.text, e.mode, t),
                    a = Tt(e, t) || "normal";
                return r = "text" === e.mode ? new Mt.MathNode("mtext", [n]) : /[0-9]/.test(e.text) ? new Mt.MathNode("mn", [n]) : "\\prime" === e.text ? new Mt.MathNode("mo", [n]) : new Mt.MathNode("mi", [n]), a !== xn[r.type] && r.setAttribute("mathvariant", a), r
            }
        });
        var wn = {
                "\\nobreak": "nobreak",
        ...
        at({
            ...
            htmlBuilder: function(e, t) {
                ...
                if (wn.hasOwnProperty(e.text)) return je.makeSpan(["mspace", wn[e.text]], [], t);
                throw new n('Unknown type of space "' + e.text + '"')
            },
            mathmlBuilder: function(e, t) {
                if (!kn.hasOwnProperty(e.text)) {
                    if (wn.hasOwnProperty(e.text)) return new Mt.MathNode("mspace");
                    throw new n('Unknown type of space "' + e.text + '"')
                }
        ...
        at({
            type: "tag",
            mathmlBuilder: function(e, t) {
                var r = new Mt.MathNode("mtable", [new Mt.MathNode("mtr", [Sn(), new Mt.MathNode("mtd", [Nt(e.body, t)]), Sn(), new Mt.MathNode("mtd", [Nt(e.tag, t)])])]);
        ...
        nt({
            ...
            htmlBuilder: function(e, t) {
                for (var r = Bn(e), n = [], a = t.havingStyle(t.style.text()), i = 0; i < r.length; i++) {
                    var o = r[i];
                    "~" === o && (o = "\\textasciitilde"), n.push(je.makeSymbol(o, "Typewriter-Regular", e.mode, a, ["mord", "texttt"]))
                }
                return je.makeSpan(["mord", "text"].concat(a.sizingClasses(t)), je.tryCombineChars(n), a)
            },
            mathmlBuilder: function(e, t) {
                var r = new Mt.TextNode(Bn(e)),
        ...
        var Bn = function(e) {
            ...
            Cn = function() {
                ...
                return e.prototype.range = function(t, r) {
                    return new e(r, qn.range(this, t))
                }, e
            }(),
            In = new RegExp("[\u0300-\u036f]+$"),
            Rn = function() {
                ...
                return t.setCatcode = function(e, t) {
                    ...
                    if (null === r || r.index !== t) throw new n("Unexpected character: '" + e[t] + "'", new Cn(e[t], new qn(this, t, t + 1)));
                    var a = r[6] || r[3] || (r[2] ? "\\ " : " ");
                    ...
                    return new Cn(a, new qn(this, t, this.tokenRegex.lastIndex))
                }, e
            }(),
            On = function() {
                function e(e, t) {
        ...
        dn("\\char", (function(e) {
            ...
            if (t) {
                if (null == (a = Hn[r.text]) || a >= t) throw new n("Invalid base-" + t + " digit " + r.text);
                for (var i; null != (i = Hn[e.future().text]) && i < t;) a *= t, a += i, e.popToken()
            }
            return "\\@char{" + a + "}"
        }));
        ...
        dn("\\newcommand", (function(e) {
            ...
            var t = e.popToken(),
                r = t.text;
            return console.log(t, e.macros.get(r), Nn[r], X.math[r], X.text[r]), ""
        ...
        var Vn = {
            ...
            Gn = function() {
                function e(e, t, r) {
                    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new On(En, t.macros), this.mode = r, this.stack = []
                }
                var t = e.prototype;
                return t.feed = function(e) {
                    ...
                    return this.pushToken(new Cn("EOF", r.loc)), this.pushTokens(n), t.range(r, "")
                    ...
                    return this.macros.has(e) ? this.expandTokens([new Cn(e)]) : void 0
                }, t.expandTokens = function(e) {
                    var t = [],
                        r = this.stack.length;
                    for (this.pushTokens(e); this.stack.length > r;) {
                        var n = this.expandOnce(!0);
                        n instanceof Cn && (n.treatAsRelax && (n.noexpand = !1, n.treatAsRelax = !1), t.push(this.stack.pop()))
                    }
                    return t
                    ...
                    return this.macros.has(e) || Nn.hasOwnProperty(e) || X.math.hasOwnProperty(e) || X.text.hasOwnProperty(e) || Vn.hasOwnProperty(e)
            ...
            Wn = function() {
                ...
                return t.expect = function(e, t) {
                    ...
                    } else if (null == (r = this.parseFunction(t, e) || this.parseSymbol()) && "\\" === i[0] && !Vn.hasOwnProperty(i)) {
                    ...
                    for (var t = e.length - 1, r = 0; r < t; ++r) {
                        ...
                        "-" === a && "-" === e[r + 1].text && (r + 1 < t && "-" === e[r + 2].text ? (e.splice(r, 3, {
                            type: "textord",
                            mode: "text",
                            loc: qn.range(n, e[r + 2]),
                            text: "---"
                        }), t -= 2) : (e.splice(r, 2, {
                            type: "textord",
                            mode: "text",
                            loc: qn.range(n, e[r + 1]),
                            text: "--"
                    ...
                    Yn.hasOwnProperty(t[0]) && !X[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = Yn[t[0]] + t.substr(1));
                    var i, o = In.exec(t);
        ...
        "undefined" != typeof document && "CSS1Compat" !== document.compatMode && ("undefined" != typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), _n = function() {
